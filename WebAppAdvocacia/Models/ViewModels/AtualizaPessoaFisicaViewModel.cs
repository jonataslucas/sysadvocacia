...
{
    public class AtualizaPessoaFisicaViewModel
    {
        ...
        [StringLength(200, ErrorMessage = "No Maximo 200 Caracteres")]
        [Display(Name = "E-Mail")]
        [Remote("VerificaEmailAtualiza", "PessoaFisica", AdditionalFields = "PessoaID, Email", ErrorMessage = "este E-Mail já existe.")]
