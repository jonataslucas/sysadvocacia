...
{
    public class AtualizaPessoaJuridicaViewModel
    {
        ...
        [StringLength(200, ErrorMessage = "No Maximo 200 Caracteres")]
        [Display(Name = "E-Mail")]
        [Remote("VerificaEmailAtualiza", "PessoaJuridica", AdditionalFields = "PessoaID, Email", ErrorMessage = "este E-Mail já existe.")]
